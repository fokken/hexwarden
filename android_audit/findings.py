...
('HW-NET-004', 'Firewall policy requires review', 'review_candidate', 'Apply an explicit default-deny policy where appropriate and allow only required traffic.', 'Review effective IPv4/IPv6/eBPF policy and test reachability from each relevant interface.'),
